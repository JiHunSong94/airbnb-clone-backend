    ...
    def post(self, request):
        try:
            ...
            access_token = requests.post(
                f"https://github.com/login/oauth/access_token?code={code}&client_id=7fcea45d2970920e009e&client_secret={settings.GH_SECRET}",
                headers={
        ...
        try:
            ...
            access_token = requests.post(
                ...
                data={
                    ...
                    "client_id": "e3da74cb1f90c0b19a8eda08db6781bb",
